...
export const FooterProvider = (props: any) => {
    return (
        <FooterContext.Provider value={{}}>
            {props.children}
            <div className='fixed bottom-0 w-full flex justify-center items-center py-4 bg-opacity-40 dark:bg-opacity-40 backdrop-blur-md bg-gray-100 dark:bg-gray-900 transition-all duration-300'>
