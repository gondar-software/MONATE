    ...
    return (
        <div>
            <h2 id={`accordion-collapse-heading-${props.id}`}>
                <button
                    type="button"
                    className={`flex items-center transition-colors duration-300 justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3 ${
                ...
                >
                    ...
                    <svg
                        data-accordion-icon
                        className={`w-3 h-3 shrink-0 ${props.isOpen ? "rotate-180" : ""} transition-transform duration-300`}
                        aria-hidden="true"
