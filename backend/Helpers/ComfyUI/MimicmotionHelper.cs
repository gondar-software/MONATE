...
{
    public static class MimicmotionHelper
    {
        ...
        {
            var workflow = JObject.Parse(File.ReadAllText("Helpers/ComfyUI/Workflows/mimicmotion-api.json"));
...
#pragma warning restore
        ...
        public static async Task<ComfyUIOutput?> GetOutput(string clientId, string promptId)
        {
            if (_inputDicts.TryGetValue(promptId, out var inputs))
            {
                ...
                {
                    Type = ComfyUIModelTypes.Mimicmotion,
